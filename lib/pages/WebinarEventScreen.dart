...
class WebinarEventScreen extends StatefulWidget {
  const WebinarEventScreen({super.key});

  @override
  _WebinarEventScreenState createState() => _WebinarEventScreenState();
}

class _WebinarEventScreenState extends State<WebinarEventScreen> {
  ...
  void _publishEvent() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Webinar Event Created Successfully!")),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Webinar Event")),
      body: Padding(
