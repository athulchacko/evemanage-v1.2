...
class ConferenceEventScreen extends StatefulWidget {
  const ConferenceEventScreen({super.key});

  @override
  _ConferenceEventScreenState createState() => _ConferenceEventScreenState();
}

class _ConferenceEventScreenState extends State<ConferenceEventScreen> {
  ...
  void _publishEvent() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Conference Event Created Successfully!")),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Conference Event")),
      body: Padding(
