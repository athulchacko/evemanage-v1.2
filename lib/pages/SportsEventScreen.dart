...
class SportsEventScreen extends StatefulWidget {
  ...
  @override
  _SportsEventScreenState createState() => _SportsEventScreenState();
}
...
class _SportsEventScreenState extends State<SportsEventScreen> {
  ...
  void _publishEvent() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Sports Event Created Successfully!")),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Sports Event")),
      body: Padding(
